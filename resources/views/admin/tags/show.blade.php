...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b border-gray-200 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <a href="{{ route('admin.tags.edit', $tag) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        Edit
                    </a>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-gray-900">{{ $tag->slug }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900">{{ $tag->created_at->format('F d, Y \a\t h:i A') }}</p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">Last Updated</label>
                        <p class="text-gray-900">{{ $tag->updated_at->format('F d, Y \a\t h:i A') }}</p>
                    </div>
                </div>
                ...
                @if($tag->posts->count() > 0)
                    <div class="border-t border-gray-200 pt-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">Posts with this Tag</h3>
                        <div class="space-y-2">
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('admin.tags.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                Back to Tags
            </a>
            <a href="{{ route('admin.tags.edit', $tag) }}" class="px-6 py-2 bg-[#142F32] text-white rounded-lg hover:bg-[#1a3f44] transition-colors">
                Edit Tag
            </a>
        </div>
    </div>
